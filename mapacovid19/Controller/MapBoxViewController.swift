...
//  mapacovid19
//
//  Created by miguel tomairo on 4/4/20.
...
class MapBoxViewController: UIViewController {
    ...
    func setupMap() {
        ...
        mapView.centerCoordinate = CLLocationCoordinate2D(latitude: -12.1661839, longitude: -76.9617751)
...
extension MapBoxViewController: MGLMapViewDelegate {
    ...
    func mapView(_ mapView: MGLMapView, didFinishLoading style: MGLStyle) {
        let url = URL(fileURLWithPath: Bundle.main.path(forResource: "covid", ofType: "geojson")!)
        ...
        ports.iconColor = NSExpression(forConstantValue: UIColor.red.withAlphaComponent(0.9))
...
extension MapBoxViewController: UIGestureRecognizerDelegate {
